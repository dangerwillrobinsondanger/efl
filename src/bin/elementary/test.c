...
void test_ui_smart_container_stack(void *data, Evas_Object *obj, void *event_info);
void test_ui_smart_container_plain(void *data, Evas_Object *obj, void *event_info);
void test_ui_smart_container_scroll(void *data, Evas_Object *obj, void *event_info);
...
#define ADD_TEST_EO(icon_, cat_, name_, cb_) _elm_test_add(&tests, icon_, cat_, name_, cb_, EINA_TRUE)
   ...
   ADD_TEST_EO(NULL, "Smart Container", "Efl.Ui.Smart_Container Plain", test_ui_smart_container_plain);
   ADD_TEST_EO(NULL, "Smart Container", "Efl.Ui.Smart_Container Scroll", test_ui_smart_container_scroll);
   ADD_TEST_EO(NULL, "Smart Container", "Efl.Ui.Smart_Container Stack", test_ui_smart_container_stack);

...
static void width_slider_cb(void *data, const Efl_Event *ev)
{
   ...
   efl_ui_smart_container_page_size_set(params->pager, EINA_SIZE2D(params->w, h));
}
...
static void height_slider_cb(void *data, const Efl_Event *ev)
{
   ...
   efl_ui_smart_container_page_size_set(params->pager, EINA_SIZE2D(w, params->h));
}
...
static void width_check_cb(void *data, const Efl_Event *ev)
{
   ...
   efl_ui_smart_container_page_size_set(params->pager, EINA_SIZE2D(w, h));
}
...
static void pack_btn_cb(void *data, const Efl_Event *ev EINA_UNUSED)
{
   ...
   switch (param->type) {
      ...
      case PACK_END:
         ...
         break;
      case PACK_BEFORE:
         index = efl_ui_smart_container_current_page_get(pager);
...
static void page_set_btn_cb(void *data, const Efl_Event *ev EINA_UNUSED)
{
   ...
   efl_ui_smart_container_current_page_set(psp->pager,
...
static void indicator_icon_btn_cb(void *data, const Efl_Event *ev EINA_UNUSED)
{
   ...
   params->indicator = efl_add(EFL_UI_SMART_CONTAINER_INDICATOR_ICON_CLASS, params->pager);
   efl_ui_smart_container_indicator_set(params->pager, params->indicator);
}

static void indicator_none_btn_cb(void *data, const Efl_Event *ev EINA_UNUSED)
{
   Params *params = data;
   efl_ui_smart_container_indicator_set(params->pager, NULL);
}
                    ...
                    void *event_info EINA_UNUSED)
{
   ...
   sp1 = efl_add(EFL_UI_SPIN_BUTTON_CLASS, in_box1,
                 ...
                 efl_ui_range_value_set(efl_added,
                                        efl_ui_smart_container_current_page_get(pager)));
...
void test_ui_smart_container_stack(void *data EINA_UNUSED,
                                   Evas_Object *obj EINA_UNUSED,
                                   void *event_info EINA_UNUSED)
{
...
void test_ui_smart_container_plain(void *data EINA_UNUSED,
                                   Evas_Object *obj EINA_UNUSED,
                                   void *event_info EINA_UNUSED)
{
  Eo *win, *panes, *navi, *list, *layout, *pager, *page;
...
void test_ui_smart_container_scroll(void *data EINA_UNUSED,
                                   Evas_Object *obj EINA_UNUSED,
                                   void *event_info EINA_UNUSED)
{
  Eo *win, *panes, *navi, *list, *layout, *pager, *page;

...
struct event_definition_generator
{
                                 ...
                                 , Context const& context) const
   {
      ...
      return as_generator(
           ...
           << scope_tab << scope_tab << scope_tab << scope_tab << scope_tab << "var ws = Efl.Eo.Globals.WrapperSupervisorPtrToManaged(data);\n"
           << scope_tab << scope_tab << scope_tab << scope_tab << scope_tab << "if (ws.Target != null)\n"
           ...
           << scope_tab << scope_tab << scope_tab << scope_tab << scope_tab << scope_tab << scope_tab << "value?.Invoke(ws.Target, args);\n"
           << scope_tab << scope_tab << scope_tab << scope_tab << scope_tab << scope_tab << "}\n"

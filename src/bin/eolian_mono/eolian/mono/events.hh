...
struct unpack_event_args_visitor
{
   ...
   {
      return as_generator("(Efl.Eo.Globals.CreateWrapperFor(evt.Info) as " + name_helpers::klass_full_concrete_or_interface_name(cls) + ")").generate(sink, attributes::unused, *context);
   }

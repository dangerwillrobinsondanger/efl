...
EOLIAN static void
_efl_ui_active_view_indicator_icon_efl_ui_active_view_indicator_content_update(Eo *obj, Efl_Ui_Active_View_Indicator_Icon_Data *pd, Efl_Gfx_Entity *subobj EINA_UNUSED, int index EINA_UNUSED, Eina_Bool deletion)
{
   if (deletion)

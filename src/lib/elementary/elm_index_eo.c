...
void _elm_index_efl_ui_directed_direction_set(Eo *obj, Elm_Index_Data *pd, Efl_Ui_Dir dir);


Efl_Ui_Dir _elm_index_efl_ui_directed_direction_get(const Eo *obj, Elm_Index_Data *pd);
...
#define ELM_INDEX_EXTRA_OPS
   ...
   EFL_OPS_DEFINE(ops,
      ...
      EFL_OBJECT_OP_FUNC(efl_ui_direction_set, _elm_index_efl_ui_directed_direction_set),
      EFL_OBJECT_OP_FUNC(efl_ui_direction_get, _elm_index_efl_ui_directed_direction_get),
...
EFL_DEFINE_CLASS(elm_index_class_get, &_elm_index_class_desc, EFL_UI_LAYOUT_BASE_CLASS, EFL_UI_DIRECTED_INTERFACE, EFL_UI_CLICKABLE_MIXIN, EFL_UI_SELECTABLE_INTERFACE, EFL_UI_LEGACY_INTERFACE, NULL);

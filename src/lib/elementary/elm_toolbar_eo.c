...
void _elm_toolbar_efl_ui_directed_direction_set(Eo *obj, Elm_Toolbar_Data *pd, Efl_Ui_Dir dir);


Efl_Ui_Dir _elm_toolbar_efl_ui_directed_direction_get(const Eo *obj, Elm_Toolbar_Data *pd);
...
#define ELM_TOOLBAR_EXTRA_OPS
   ...
   EFL_OPS_DEFINE(ops,
      ...
      EFL_OBJECT_OP_FUNC(efl_ui_direction_set, _elm_toolbar_efl_ui_directed_direction_set),
      EFL_OBJECT_OP_FUNC(efl_ui_direction_get, _elm_toolbar_efl_ui_directed_direction_get),

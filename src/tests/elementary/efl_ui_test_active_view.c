...
static void
_indicator_content_update(Eo *obj EINA_UNUSED, void *pd EINA_UNUSED, Efl_Gfx_Entity *subobj, int index EINA_UNUSED, Eina_Bool deletion)
{
   indicator_calls.content_update.called ++;
   indicator_calls.content_update.subobj = subobj;
   indicator_calls.content_update.index = index;
   indicator_calls.content_update.deletion = deletion;
   indicator_calls.content_update.current_page_at_call = efl_ui_active_view_active_index_get(container);
}
...
EFL_OPS_DEFINE(indicator_tracker,
  EFL_OBJECT_OP_FUNC(efl_ui_active_view_indicator_content_update, _indicator_content_update),
...
static void
_transition_content_update(Eo *obj EINA_UNUSED, void *pd EINA_UNUSED, Efl_Gfx_Entity *subobj, int index EINA_UNUSED, Eina_Bool deletion)
{
   transition_calls.content_update.called ++;
   transition_calls.content_update.subobj = subobj;
   transition_calls.content_update.index = index;
   transition_calls.content_update.deletion = deletion;
   transition_calls.content_update.current_page_at_call = efl_ui_active_view_active_index_get(container);
...
EFL_OPS_DEFINE(transition_tracker,
  EFL_OBJECT_OP_FUNC(efl_ui_active_view_view_manager_animation_set, _transition_animation_set),
  EFL_OBJECT_OP_FUNC(efl_ui_active_view_view_manager_animation_get, _transition_animation_get),
  EFL_OBJECT_OP_FUNC(efl_ui_active_view_view_manager_content_update, _transition_content_update),
  EFL_OBJECT_OP_FUNC(efl_ui_active_view_view_manager_request_switch, _transition_request_switch),
...
EFL_START_TEST (efl_ui_smart_transition_calls)
{
   ...
   ck_assert_int_eq(transition_calls.content_update.called, 0);
   ...
   ck_assert_int_eq(transition_calls.content_update.called, 1);
   ck_assert_int_eq(transition_calls.content_update.index, 0);
   ck_assert_int_eq(transition_calls.content_update.deletion, EINA_FALSE);
   ck_assert_ptr_eq(transition_calls.content_update.subobj, w);
   ck_assert_int_eq(transition_calls.content_update.current_page_at_call, -1);
   transition_calls.content_update.called = 0;
   ...
   ck_assert_int_eq(transition_calls.content_update.index, 0);
   ck_assert_int_eq(transition_calls.content_update.deletion, EINA_FALSE);
   ck_assert_ptr_eq(transition_calls.content_update.subobj, w1);
   ck_assert_int_eq(transition_calls.content_update.current_page_at_call, 1);
   transition_calls.content_update.called = 0;
   transition_calls.request_switch.called = 0;
   ck_assert_int_eq(efl_ui_active_view_active_index_get(container), 1);
   ...
   ck_assert_int_eq(transition_calls.request_switch.called, 0);
   ck_assert_int_eq(transition_calls.content_update.called, 1);
   ck_assert_int_eq(transition_calls.content_update.index, 2);
   ck_assert_int_eq(transition_calls.content_update.deletion, EINA_FALSE);
   ck_assert_ptr_eq(transition_calls.content_update.subobj, w2);
   ck_assert_int_eq(transition_calls.content_update.current_page_at_call, 1);
   transition_calls.content_update.called = 0;
   ck_assert_int_eq(efl_ui_active_view_active_index_get(container), 1);
   ...
   ck_assert_int_eq(transition_calls.request_switch.called, 0);
   ck_assert_int_eq(transition_calls.content_update.called, 1);
   ck_assert_int_eq(transition_calls.content_update.index, 1);
   ck_assert_int_eq(transition_calls.content_update.deletion, EINA_TRUE);
   ck_assert_ptr_eq(transition_calls.content_update.subobj, w);
   transition_calls.content_update.called = 0;
}
EFL_END_TEST
...
_verify_indicator_calls(void)
{
   ...
   ck_assert_int_eq(indicator_calls.content_update.called, 0);
   ...
   ck_assert_int_eq(indicator_calls.content_update.called, 1);
   ck_assert_int_eq(indicator_calls.content_update.index, 0);
   ck_assert_ptr_eq(indicator_calls.content_update.subobj, w);
   ck_assert_int_eq(indicator_calls.content_update.deletion, EINA_FALSE);
   ck_assert_int_eq(indicator_calls.position_update.called, 1);
   ck_assert_double_eq(indicator_calls.position_update.position, 0.0);
   indicator_calls.content_update.called = 0;
   ...
   ck_assert_int_eq(indicator_calls.content_update.called, 1);
   ck_assert_int_eq(indicator_calls.content_update.index, 0);
   ck_assert_ptr_eq(indicator_calls.content_update.subobj, w1);
   ck_assert_int_eq(indicator_calls.content_update.deletion, EINA_FALSE);
   ck_assert_int_eq(indicator_calls.position_update.called, 1);
   ck_assert_double_eq(indicator_calls.position_update.position, 1.0);
   indicator_calls.content_update.called = 0;
   indicator_calls.position_update.called = 0;
   ...
   ck_assert_int_eq(indicator_calls.active_view.called, 0);
   ck_assert_int_eq(indicator_calls.content_update.called, 1);
   ck_assert_int_eq(indicator_calls.content_update.index, 2);
   ck_assert_ptr_eq(indicator_calls.content_update.subobj, w2);
   ck_assert_int_eq(indicator_calls.content_update.deletion, EINA_FALSE);
   ck_assert_int_eq(indicator_calls.position_update.called, 0);
   indicator_calls.content_update.called = 0;
   indicator_calls.position_update.called = 0;
   ...
   ck_assert_int_eq(indicator_calls.content_update.index, 0);
   ck_assert_ptr_eq(indicator_calls.content_update.subobj, w1);
   ck_assert_int_eq(indicator_calls.content_update.deletion, EINA_TRUE);
   ck_assert_int_eq(indicator_calls.position_update.called, 1);
   ck_assert_double_eq(indicator_calls.position_update.position, 0.0);
   indicator_calls.content_update.called = 0;
   indicator_calls.position_update.called = 0;
